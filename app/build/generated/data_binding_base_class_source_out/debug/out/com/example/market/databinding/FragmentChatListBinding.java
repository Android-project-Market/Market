...
public final class FragmentChatListBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView chattingTitle;

  private FragmentChatListBinding(@NonNull FrameLayout rootView, @NonNull TextView chattingTitle) {
  ...
  public static FragmentChatListBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.chattingTitle;
      TextView chattingTitle = ViewBindings.findChildViewById(rootView, id);
      if (chattingTitle == null) {
        break missingId;
      }

      return new FragmentChatListBinding((FrameLayout) rootView, chattingTitle);
    }
